...
ten_percent_indx_g1 = find(abs(gs1 - 0.1*g1_steady)<0.001)($)
ninety_percent_indx_g1 = find(abs(gs1 - 0.9*g1_steady)<0.001)(1)

rise_time_g1 = t(ninety_percent_indx_g1) - t(ten_percent_indx_g1);
disp(rise_time_g1,' Rise time of the sytem with added pole is ')
...
disp(os_g1, 'Percentage overshoot of the sytem with added pole is ');


plot2d(t , gs, style =1)
plot2d(t, gs1,style =2)

h = legend(['Original system' , 'System with added pole'])
